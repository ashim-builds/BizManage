    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl z-10">
        ...
        <button
          ...
          className="w-full mb-6 py-2.5 px-4 rounded-xl bg-slate-800 hover:bg-slate-750 border border-slate-700 text-white text-xs font-medium flex items-center justify-center gap-3 transition-all hover:border-slate-600 shadow-md"
        >
        ...
        <div className="relative mb-6 text-center">
          ...
          <span className="relative px-3 bg-slate-900 text-[11px] text-slate-500 uppercase font-medium">Or register with email</span>
        </div>
