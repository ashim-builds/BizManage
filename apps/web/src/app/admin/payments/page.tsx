          ...
          <>
            ...
            <div className="lg:hidden divide-y divide-slate-800/80">
              {filteredRequests.map((r) => {
                ...
                return (
                  <div key={r.id} className="p-4 space-y-3 bg-slate-900/90">
                    {/* Top Row: Business Name & Status */}
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0 flex-1">
                        <h3 className="font-bold text-white text-base truncate">{r.business.name}</h3>
                      ...
                      <div className="shrink-0">
                        ...
                        {isRejected && (
                          <span className="px-2 py-0.5 rounded-full bg-rose-500/10 text-rose-400 border border-rose-500/20 text-[10px] font-bold inline-flex items-center gap-1">
                            <XCircle className="w-3 h-3" /> Rejected
                          </span>
                        )}
                      </div>
                    ...
                    <div className="p-3 rounded-xl bg-slate-950/80 border border-slate-800/80 space-y-2 text-xs">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-mono font-bold text-blue-300 bg-slate-900 px-2 py-0.5 rounded border border-slate-800">
                          {r.referenceId}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-white font-medium">
                          {r.verificationResponse?.senderName || 'Garima Bikas Bank QR'}
                        </span>
                      </div>
                      ...
                      {r.failureReason && (
                        <div className="p-2 rounded-lg bg-rose-500/10 border border-rose-500/20 text-rose-300 text-[11px]">
                          <strong>Rejection reason:</strong> {r.failureReason}
                        </div>
                      )}
                    </div>
                    ...
                    {isPending && (
                      <div className="flex items-center gap-2 pt-1">
                        <button
                          ...
                          disabled={isActioning}
                          onClick={() => handleOpenRejectModal(r)}
                          className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-slate-800 hover:bg-rose-500/20 text-rose-400 border border-slate-700 text-xs font-semibold transition-all disabled:opacity-50"
                        >
                        ...
                        <button
                          ...
                          disabled={isActioning}
                          onClick={() => handleOpenApproveModal(r)}
                          className="flex-2 flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold shadow-md shadow-emerald-600/20 transition-all disabled:opacity-50"
                        >
