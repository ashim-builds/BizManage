                    ...
                    <td className="px-6 py-4 text-right font-mono font-bold">
                      {isReceivable && (
                        <span className="text-emerald-400">
                          ...
                          <span className="text-[10px] font-semibold uppercase px-1.5 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20">
                            Receive
                          </span>
                        </span>
                      )}
                      {isPayable && (
                        <span className="text-rose-400">
                          ...
                          <span className="text-[10px] font-semibold uppercase px-1.5 py-0.5 rounded bg-rose-500/10 border border-rose-500/20">
                            Give
                          </span>
                        </span>
                      )}
                      {!isReceivable && !isPayable && <span className="text-slate-500">Rs. 0 (Settled)</span>}
                    </td>
