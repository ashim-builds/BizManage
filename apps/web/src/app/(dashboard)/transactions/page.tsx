...
export default function TransactionsPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-3 sm:px-6 py-4 font-sans pb-12">
      ...
      {/* Filters */}
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row gap-3 md:items-end">
        <div className="flex-1 w-full">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all cursor-pointer min-h-[44px]"
            >
        ...
        <button
          ...
          className="w-full md:w-auto px-4 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold border border-slate-200 transition-all flex items-center justify-center gap-1.5 cursor-pointer min-h-[44px]"
        >
