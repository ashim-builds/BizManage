  ...
  const renderMobileCard = (r: any) => {
    ...
    return (
      <div className="bg-white rounded-2xl p-4 border border-slate-200/80 shadow-xs hover:border-slate-300 transition-all space-y-3">
        {/* Top: Return Vendor + Total Amount */}
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="w-9 h-9 rounded-xl bg-purple-50 border border-purple-100 flex items-center justify-center text-purple-600 shrink-0 font-bold">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-1.5 text-[11px] text-slate-500 font-medium">
                ...
                <span>•</span>
                <span className="font-mono font-semibold text-purple-700">#{r.returnNumber}</span>
              </div>
            </div>
          </div>
          ...
          <div className="text-right shrink-0">
            ...
            <span className="text-[10px] font-bold uppercase tracking-wider text-purple-700 bg-purple-50 px-1.5 py-0.5 rounded border border-purple-100">
              Debit Note
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-100 text-xs">
          <div className="space-y-0.5">
            <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Original Bill</span>
            <p className="text-slate-700 font-semibold truncate">
              {r.purchase?.billNumber ? (
                <span className="text-purple-700 font-mono bg-purple-50 px-1.5 py-0.5 rounded border border-purple-100 text-[11px]">
                  {r.purchase.billNumber}
                </span>
              ) : (
        ...
        <div className="pt-2 border-t border-slate-100 flex items-center justify-end">
          ...
          >
            <Eye className="w-3.5 h-3.5" /> View Debit Note
          </Link>
        </div>
      </div>
    );
    ...
    <div className="max-w-7xl mx-auto space-y-6 px-3 sm:px-6 py-4">
      ...
      <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-30 lg:hidden pointer-events-auto">
        ...
        >
          ...
          <span>Issue Debit Note (खरिद फिर्ता)</span>
        </button>
      </div>
    </div>
  );
