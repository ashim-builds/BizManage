    ...
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 space-y-4 print:bg-white print:text-black print:border-none print:p-0">
        <div className="flex flex-wrap items-center justify-between border-b border-slate-800 pb-4 gap-4 print:border-black">
          <div>
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-md bg-blue-500/10 text-blue-400 border border-blue-500/20 text-[10px] font-bold uppercase print:hidden">
                IRD Nepal Format
              </span>
          ...
          <div className="flex items-center gap-2 print:hidden">
            ...
            >
              <Printer className="w-4 h-4" /> Print Annex-5
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
          ...
          <div className="p-3 rounded-xl bg-slate-800/40 border border-slate-800 print:border-gray-300 print:bg-white">
            ...
            <p className="font-mono font-bold text-blue-400 print:text-black text-sm mt-0.5">{businessPan}</p>
          </div>
          <div className="p-3 rounded-xl bg-slate-800/40 border border-slate-800 print:border-gray-300 print:bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 print:grid-cols-4">
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 print:border-gray-300 print:bg-white">
          <p className="text-[10px] font-bold text-slate-400 uppercase">जम्मा बिक्री (Total Sales)</p>
          <h3 className="text-xl font-bold font-mono text-white print:text-black mt-1">
            Rs. {totals.totalSales.toLocaleString(undefined, { minimumFractionDigits: 2 })}
          </h3>
        </div>
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 print:border-gray-300 print:bg-white">
          <p className="text-[10px] font-bold text-blue-400 uppercase">करयोग्य बिक्री (Taxable Sales)</p>
          <h3 className="text-xl font-bold font-mono text-blue-400 print:text-black mt-1">
            Rs. {totals.totalTaxable.toLocaleString(undefined, { minimumFractionDigits: 2 })}
          </h3>
        </div>
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 print:border-gray-300 print:bg-white">
          <p className="text-[10px] font-bold text-amber-400 uppercase">मूल्य अभिवृद्धि कर (13% VAT)</p>
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 print:border-gray-300 print:bg-white">
          <p className="text-[10px] font-bold text-slate-400 uppercase">कर छुट बिक्री (Tax Exempt)</p>
        ...
        <table className="w-full text-left text-xs min-w-[900px]">
          ...
          <tbody className="divide-y divide-slate-800/60 print:divide-gray-300 text-slate-300 print:text-black">
            {sales.length === 0 ? (
              ...
              sales.map((s, idx) => {
                ...
                return (
                  <tr key={s.id || idx} className="hover:bg-slate-800/30 print:hover:bg-transparent transition-colors">
                    ...
                    <td className="px-4 py-3 text-right font-mono font-bold text-blue-300 print:text-black">
          ...
          <tfoot className="bg-slate-800/90 print:bg-gray-100 font-bold border-t-2 border-slate-700 print:border-black text-white print:text-black">
            <tr>
              ...
              <td className="px-4 py-3 text-right font-mono text-blue-300 print:text-black">
                Rs. {totals.totalTaxable.toLocaleString(undefined, { minimumFractionDigits: 2 })}
              </td>
