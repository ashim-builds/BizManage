...
export function UserGuide({ initialLanguage = 'np', showLanguageSelector = true }: UserGuideProps) {
  ...
  const guideSections = [
    ...
    },
    {
      ...
      titleNp: '१२. अनलाइन वेबसाइट, सामानको फोटो र अर्डर व्यवस्थापन (Online Website Builder & Order Management)',
      titleEn: '12. Online Storefront Builder, Product Photo Catalogs & Online Orders Manager',
      summaryNp: 'तपाईंको पसलको अनलाइन वेबसाइट बनाउने, सामानको फोटो राख्ने, र ड्यासबोर्डबाट ग्राहकका अनलाइन अर्डरहरू व्यवस्थापन गर्ने तरिका।',
      summaryEn: 'Build your public e-commerce catalog, upload product photos, display transparent prices, and manage incoming web orders from your dashboard.',
      stepsNp: [
        {
          title: 'अनलाइन स्टोर र प्रोफाइल लोगो चालू गर्ने (Enable Website & Logo Branding)',
          desc: 'Left Menu -> "Online Website" (storefront) मा जानुहोस्। "Enable Public Website & Catalog" चालू गर्नुहोस् र पसलको लिङ्क (https://bizmanage-web.onrender.com/store/rb-hardware) बनाउनुहोस्। तपाईंको पसलको लोगो स्टोरको Header मा स्वतः देखिन्छ।',
        },
        {
          title: 'सामानको फोटो र विवरण थप्ने (Product Image & Description)',
          desc: 'Inventory -> "Add Item" वा "Edit Item" मा गएर Product Image URL (जस्तै: https://example.com/item.jpg) र Store Description राख्नुहोस्। अनलाइन स्टोरमा ग्राहकहरूले सामानको फोटो र मूल्य स्पष्ट देख्न पाउँछन्।',
        },
        {
          title: 'अनलाइन अर्डर म्यानेजर (Online Orders Manager Tab)',
          desc: 'Online Website ड्यासबोर्डमा रहेको "Online Orders Manager" ट्याबबाट ग्राहकका सबै अर्डरहरू (WEB-00001) हेर्न सकिन्छ। यहाँबाट सिधै ह्वाट्सएपमा सम्पर्क गर्न, अर्डर स्वीकृत गरी "Mark Paid" थिचेर रकम असुल गर्न र बिल छाप्न सकिन्छ।',
        },
        {
          title: 'ग्राहकले अर्डर गर्ने दुई तरिका (WhatsApp Checkout & Direct Web Invoice)',
          desc: '१. Order via WhatsApp: सामानको सूची र जम्मा रकम सहित ह्वाट्सएपमा अर्डर सन्देश पठाइन्छ।\n२. Submit Direct Online Order: अर्डर बिजम्यानेजमा पन्डिङ बिक्री बिलको रूपमा दर्ता हुन्छ र स्टक हिसाब स्वतः घट्छ।',
        },
      ],
      stepsEn: [
        {
          title: 'Enabling Your Online Website & Logo Branding',
          desc: 'Navigate to Sidebar Navigation -> "Online Website". Toggle the switch to publish your store live on the web (https://bizmanage-web.onrender.com/store/your-shop). Your uploaded business logo automatically renders across your store header.',
        },
        {
          title: 'Adding Product Photos & Store Descriptions',
          desc: 'When creating or editing inventory items under Inventory Management, enter your Product Image URL (e.g. https://example.com/photo.jpg) and Store Description. Photos will display on public catalog cards with hover zoom animations.',
        },
        {
          title: 'Managing Web Orders via Online Orders Manager Tab',
          desc: 'Switch to the "Online Orders Manager" tab in your Storefront Dashboard to view incoming customer orders (WEB-00001). Easily contact customers via WhatsApp, track unpaid balances, and click "Mark Paid" to confirm payment.',
        },
        {
          title: 'Customer Order Workflows (WhatsApp & Direct Web Invoice)',
          desc: 'Customers can place orders via two seamless options:\n1. Order via WhatsApp: Generates an itemized order message with total prices.\n2. Submit Direct Online Order: Instantly registers a sales invoice lead in your BizManage ledger with automatic stock deduction.',
        },
      ],
      quickLink: '/storefront',
      quickLinkTextNp: 'अनलाइन वेबसाइट र अर्डर ड्यासबोर्ड खोल्नुहोस् →',
      quickLinkTextEn: 'Open Online Storefront Dashboard →',
    },
  ];
