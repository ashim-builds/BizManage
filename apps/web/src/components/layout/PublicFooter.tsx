        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="flex items-center space-x-3 group">
              ...
              />
              <span className="text-2xl font-black tracking-tight text-slate-900">BizManage</span>
            </Link>

            <p className="text-xs sm:text-sm text-slate-500 max-w-sm leading-relaxed">
              Production-ready multi-tenant Business Management & Accounting application built for modern retail stores,
              hardware shops, and enterprise businesses.
            </p>
            ...
            <div className="space-y-2 text-xs text-slate-500 pt-1">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span>supprot@bizmange.com</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              <span className="text-xs font-semibold text-slate-600">All Systems Operational · 99.99% Uptime</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm text-slate-600">
              <li>
                <Link href="/about" className="hover:text-black transition-colors font-semibold">
                  About BizManage
                </Link>
              </li>
              <li className="text-slate-600">Made for small businesses</li>
              <li className="text-slate-600">GST & PAN billing ready</li>
              <li className="text-slate-600">Trusted by business owners</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-600">
              <li>
                <Link
                  href="/explore-stores"
                  className="hover:text-emerald-700 transition-colors text-emerald-600 font-semibold"
                >
              ...
              <li>
                {!authLoading && user ? (
                  <Link
                    href={dashboardHref}
                    className="hover:text-slate-900 transition-colors font-bold text-red-600 flex items-center gap-1"
                  >
              ...
              <li>
                <Link
                  href="/admin/login"
                  className="inline-flex items-center gap-1.5 hover:text-slate-900 transition-colors text-amber-600 font-semibold"
                >
